...
- Unified Write Model：ADR-0010 已实现统一 database layer、Candidate handoff、Acceptance、typed Canonical Object、normalized provenance、review/tombstone 和动态数据库迁移/恢复；2026-07-15 真实本地库已切换并完成守恒、幂等复核。
